...
$data modify storage stringlib:temp data.TempList append from storage stringlib:zprivate data.CharMap[{u:"$(Char)"}].l
...
function stringlib:zprivate/to_lowercase/main with storage stringlib:temp data
