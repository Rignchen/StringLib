...
execute if score #StringLib.FoundNothing StringLib matches 1 run return run execute unless data storage stringlib:output {find:[-1]} run data remove storage stringlib:output find[-1]
...
function stringlib:zprivate/find/reversed/main
